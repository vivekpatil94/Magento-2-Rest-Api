...
class CatalogProductTypeListV1Api
{
     ...
     * @return \Swagger\Client\Model\CatalogDataProductTypeInterface[]
     */
     ...
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\CatalogDataProductTypeInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function catalogProductTypeListV1GetProductTypesGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\CatalogDataProductTypeInterface[]',
                '/V1/products/types'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\CatalogDataProductTypeInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\CatalogDataProductTypeInterface[]', $e->getResponseHeaders());
