...
class StoreStoreRepositoryV1Api
{
     ...
     * @return \Swagger\Client\Model\StoreDataStoreInterface[]
     */
     ...
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return array of \Swagger\Client\Model\StoreDataStoreInterface[], HTTP status code, HTTP response headers (array of strings)
     */
    public function storeStoreRepositoryV1GetListGetWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\StoreDataStoreInterface[]',
                '/V1/store/storeViews'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\StoreDataStoreInterface[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\StoreDataStoreInterface[]', $e->getResponseHeaders());
